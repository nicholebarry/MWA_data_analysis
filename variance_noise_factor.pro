...
;    obs = getvar_savefile('/nfs/mwa-09/r1/djc/EoR2013/Aug23/fhd_nb_decon_March2016_small_through_firstpass_largeind/metadata/'+strtrim(string(obsids[obs_i]),2)+'_obs.sav','obs')
...
;  vis_sigma = total(vis_noise*nf_vis)/total(nf_vis)
  ...
  data_odd = getvar_savefile(fhd_path+'/'+ps_dir+'/Combined_obs_'+obs_name+'_odd_cube'+pol+deluv + '_res_uvf.idlsave','data_cube')
  data_even = getvar_savefile(fhd_path+'/'+ps_dir+'/Combined_obs_'+obs_name+'_even_cube'+pol+deluv +'_res_uvf.idlsave','data_cube')
  ...
  variance_odd = getvar_savefile(fhd_path+'/'+ps_dir+'/Combined_obs_'+obs_name+'_odd_cube'+pol+deluv +'_weights_uvf.idlsave','variance_cube')
  variance_even = getvar_savefile(fhd_path+'/'+ps_dir+'/Combined_obs_'+obs_name+'_even_cube'+pol+deluv +'_weights_uvf.idlsave','variance_cube')
  ...
  weights_odd = getvar_savefile(fhd_path+'/'+ps_dir+'/Combined_obs_'+obs_name+'_odd_cube'+pol+deluv +'_weights_uvf.idlsave','weights_cube')
  weights_even = getvar_savefile(fhd_path+'/'+ps_dir+'/Combined_obs_'+obs_name+'_even_cube'+pol+deluv +'_weights_uvf.idlsave','weights_cube')
  ...
  xarr = getvar_savefile(fhd_path+'/'+ps_dir+'/Combined_obs_'+obs_name+'_odd_cube'+pol+deluv +'_weights_uv_plane.idlsave','xarr')
  yarr = getvar_savefile(fhd_path+'/'+ps_dir+'/Combined_obs_'+obs_name+'_odd_cube'+pol+deluv +'_weights_uv_plane.idlsave','yarr')
  kperp_lambda_conv = getvar_savefile(fhd_path+'/'+ps_dir+'/Combined_obs_'+obs_name+'_odd_cube'+pol+deluv +'_weights_uv_plane.idlsave','kperp_lambda_conv')
