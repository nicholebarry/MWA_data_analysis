...
;No keywords needed
   ...
   'nb_polarized_diffuse_Oct2015':begin
      ...
      snapshot_healpix_export=1
      recalculate_all=1
      ;grid_interpolate turn on, turn down psf_resolution (look at double beam tests to find right psf_res) 
      ;;maybe run a 2048 test
      ;;set recalculate_all=0, it will redo deconvolution if the decon keyword is set
      ;double memory, time
   end
   ...
   'nb_decon_Feb2016_through_firstpass': begin
      ;max_calibration_sources=1000
      undefine, diffuse_calibrate, diffuse_model
      calibration_catalog_file_path='/nfs/mwa-09/r1/djc/EoR2013/Aug23/fhd_nb_decon_Feb2016/output_data/'+obs_id+'_source_array.sav'
      saved_run_bp=0
   end
