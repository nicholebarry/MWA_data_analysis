...
;No keywords needed
   ...
   'nb_sim_beamperchannel':begin 
      nfreq_avg=1
      ;unflag_all=1
      recalculate_all=1
   end    
   'nb_sim_beamperchannel_unflagged':begin 
      nfreq_avg=1
      unflag_all=1
      recalculate_all=1
   end   
   'nb_sim_beamperchannel_unflagged_v2':begin 
      nfreq_avg=1
      no_frequency_flagging=1
      recalculate_all=1
   end   
   'nb_decon_Aug2015_notimecut':begin 
      max_sources=200000
      dft_threshold=1
      gain_factor=0.1
      deconvolve=1
   ...
   'nb_longrunpoly_v2':begin 
       saved_run_std_test_polyquad=1
       
   end
   'nb_longrunpoly_longrunmode':begin 
       saved_run_std_test_polyquad=1
   end
   'nb_twopolyquad_longrunmode_normfix':begin 
       saved_run_std_test_polyquad=1
   end
   'nb_twopolyquad_longrunmode_normfix_v2':begin 
       saved_run_twopoly_meanmode=1
   end
   
   'nb_sim_perfect_cal_beamperchannel':begin 
      calibrate_visibilities=0
      export_images=0
      unflag_all=1
   end
   'nb_sim_orig_cal_beamperchannel':begin 
      saved_run_bp=0
      cable_bandpass_fit=0
      unflag_all=1
   end
   'nb_sim_overfit_cal_beamperchannel':begin 
      over_calibrate=1
      unflag_all=1
   end
   ...
   'nb_sim_overfit_cal_beamperchannel_modelnoflag_recalc':begin 
      over_calibrate=1
      unflag_all=1
      cal_sim=1
      nfreq_avg=1
   ...
   'nb_sim_orig_cal_beamperchannel_modelnoflag':begin 
      saved_run_bp=0
      cable_bandpass_fit=0
      unflag_all=1
      cal_sim=1
   ...
   'nb_sim_overfit_cal_beamperchannel_modelnoflag':begin 
      over_calibrate=1
      unflag_all=1
      cal_sim=1
      no_frequency_flagging=1
   end
   'nb_sim_cable_cal_beamperchannel_modelnoflag':begin 
      cable_bandpass_fit=1
      saved_run_bp=0
      unflag_all=1
      cal_sim=1
   ...
   'nb_sim_overfit_fitphase_cal_beamperchannel_modelnoflag':begin 
      saved_run_bp=0
      cable_bandpass_fit=0
      unflag_all=1
      cal_sim=1
