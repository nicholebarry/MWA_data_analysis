pro make_pol_source7

; A polarized source off-zenith
id = 8

ra = 359.0 ; obsra= 359.8494 degrees

dec = -18.0 ; obsdec = -26.783640 degrees
...
save_path=filepath('Vsource'+number_formatter(id)+'.sav',root=rootdir('FHD'),subdir='catalog_data')
