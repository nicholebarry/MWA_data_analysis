    ...
    for poi_i=0,4 do begin
      for freq_i=0, 383 do begin
        for tile_i=0,127 do begin
          ...
          resistant_mean, reform(abs(gain[pol_i,poi_tiles,freq_i,tile_i])), 2, res_mean
          resistant_mean, reform(atan(gain[pol_i,poi_tiles,freq_i,tile_i],/phase)), 2, phase_mean
