pro jack_to_catalog_sav

make_lobes_catalog=1
  if keyword_set(make_lobes_catalog) then begin
  
    ;Read the lobes catalog from fits
    lobes_fits = '/fred/oz048/MWA/CODE/FHD/Jack_sim/1093626984/GLEAM_ECG+gal-plane.fits'
...
;      endif
      ...
      pre_ra[source_i]=lobes_read[source_i].RAJ2000
      pre_dec[source_i]=lobes_read[source_i].DEJ2000
      pre_Jy_sources[source_i]=lobes_read[source_i].FINTWIDE
      ;pre_err_Jy_sources[source_i]=lobes_read[source_i].err_int_flx181
      ;shape_struct={x:0.,y:0.,angle:0.}
      pre_major_dc[source_i]=lobes_read[source_i].AWIDE
      pre_minor_dc[source_i]=lobes_read[source_i].BWIDE
      pre_pa_dc[source_i]=lobes_read[source_i].PAWIDE
    endfor

    flux_scale=(182.39500/200)^(-.7)
    pre_Jy_sources*=flux_scale
    ...
    save, catalog, filename='/fred/oz048/MWA/CODE/FHD/Jack_sim/1093626984/GLEAM_ECG+gal-plane.sav'
  endif
