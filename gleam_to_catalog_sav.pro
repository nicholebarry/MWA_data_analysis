pro GLEAM_to_catalog_sav

make_GLEAM_catalog=1
  if keyword_set(make_GLEAM_catalog) then begin
  
    ;Read the GLEAM catalog from fits
    gleam_fits = '/nfs/mwa-00/h1/nbarry/MWA/IDL_code/FHD/catalog_data/GLEAMIDR4.fits'
    gleam_read = mrdfits(gleam_fits, 1)
    n_source = (size(gleam_read))[1]
    ...
    for source_i=0,n_source-1 do begin
      ...
      pre_ra[source_i]=gleam_read[source_i].RAJ2000
      pre_dec[source_i]=gleam_read[source_i].DEJ2000
      pre_Jy_sources[source_i]=gleam_read[source_i].int_flux_181
      pre_err_Jy_sources[source_i]=gleam_read[source_i].err_int_flux_181
    endfor
    freq=181
    ...
    save, catalog, filename='/nfs/mwa-00/h1/nbarry/MWA/IDL_code/FHD/catalog_data/GLEAMIDR4_181_consistent.sav'
  endif
