pro kslice_wrapper
  ...
  ;power_filename = '/nfs/mwa-04/r1/EoRuvfits/analysis/fhd_nb_sim_uvf_pskspan60/ps/Combined_obs_'+obs_name+'_cubeXX__even_odd_joint_dirty_yy_averemove_bh_power.idlsave'
  power_filename = '/nfs/mwa-04/r1/EoRuvfits/analysis/fhd_nb_sim_uvf_pskspan300/ps_uvf/'+obs_name+'_gridded_uvf__even_odd_joint_res_yy_averemove_bh_power.idlsave'
  ...
  ;metadata_struct = getvar_savefile('/nfs/mwa-04/r1/EoRuvfits/analysis/fhd_nb_sim_uvf_pskspan60/ps/Combined_obs_'+obs_name+'_cubeXX__even_odd_joint_info.idlsave','metadata_struct')
  ...
  ;for kz_i=0, N_elements(freq)/2-1 do begin
    ...
    plotfile='/nfs/mwa-04/r1/EoRuvfits/analysis/fhd_nb_sim_uvf_pskspan150/kzslice_weights_'+string(strtrim(kz_i,2),FORMAT='(I03)')
    ...
    kpower_slice_plot, power=reform(weights_3d[*,*,kz_i]), xarr=kx_mpc, yarr=ky_mpc, kz_mpc = kz_mpc[kz_i], /baseline_axis, /plot_wedge_line, $
      slice_axis=2, kperp_lambda_conv = kperp_lambda_conv, wedge_amp=wedge_amp, /linear_axes,charsize_in=1,window=8
      ;,plotfile=plotfile,/png;,data_range=[10^9.,10^15.];,plotfile=plotfile,/png;, data_range=[10^3.,10^15.]
          stop
  ;endfor
