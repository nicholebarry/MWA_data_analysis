FUNCTION vis_cal_temp2,vis_ptr,vis_model_ptr,vis_weight_ptr,obs,params,cal,preserve_visibilities=preserve_visibilities,$
  ...
  ;window_expand = rebin(reform(window,n_freq,1,1), n_freq, n_baselines, /sample)
    ...
    ;vis_avg=fft(vis_model*vis_gain,dimension=1)
    ...
    cal_tau = getvar_savefile('/nfs/mwa-09/r1/djc/EoR2013/Aug23/fhd_nb_sim_overfit_cal_eor_ones_short_baselines_included/added_sine_cal_return_tau_lineremove.sav','cal_return')
    ;cal_tau = getvar_savefile('/nfs/mwa-09/r1/djc/EoR2013/Aug23/fhd_nb_sim_overfit_cal_eor_ones_short_baselines_included/calibration/1061316176_cal.sav','cal')
    gain_arr_tau = (*cal_tau.gain[pol_i])
    ...
    ;MY CHANGE vis_avg -> vis_data_Save
    nan_i=where(Finite(vis_data_save,/nan),n_nan)
