pro dft_checker
  ...
  gain_arr=10*Cos(2*!Pi*5*((FINDGEN(100)/100))+!Pi)+i_comp;+5 ;frequency of 2, once a second for 380/380 seconds, amplitude of 10
  ...
  ;dmode=0.1
  nmodes=200 ; range around the central mode to test
  ...
  ;**************
  test_fits=Total(exp(i_comp*2.*!Pi/100*modes*(freq_mat))*gain_temp,2)
